...
import tempfile
import shutil
from repo_folder_to_single_text import process_repository, get_ignore_list
...
class TestGPTRepositoryLoader(unittest.TestCase):
    ...
    def test_end_to_end(self):
       ...
       # Run the repo-folder-to-single-text-for-gpt-prompt script on the example repository
